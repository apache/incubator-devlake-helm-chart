...
1. Please copy the ENCODE_KEY value from /app/config/.env of the pod devlake-lake-0, and replace <ENCRYPTION_SECRET> of below upgrade cmd

2. You will encounter the error when upgrading, that's because the build-in grafana will be replaced by the official grafana dependency. 
