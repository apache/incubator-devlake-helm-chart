...
```shell
helm repo update
helm upgrade devlake devlake/devlake --version=1.0.0-beta6 --set lake.encryptionSecret.secret=<ENCRYPTION_SECRET>
```
...
```shell
helm repo update
helm upgrade devlake devlake/devlake --version=1.0.0-beta6
```
